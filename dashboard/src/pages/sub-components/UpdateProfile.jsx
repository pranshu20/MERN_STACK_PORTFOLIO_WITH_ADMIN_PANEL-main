...
const UpdateProfile = () => {
  ...
  const [aboutSection1, setAboutSection1] = useState(
    user && user.aboutSection1
  );
  const [aboutSection2, setAboutSection2] = useState(
    user && user.aboutSection2
  );
  ...
  const handleUpdateProfile = () => {
    ...
    formData.append("aboutSection1", aboutSection1);
    formData.append("aboutSection2", aboutSection2);
        ...
        <div>
          <div className="grid w-[100%] gap-6">
            ...
            <div className="grid gap-4">
              ...
              <div className="grid gap-2">
                <Label>About Section 1</Label>
                <Textarea
                  className="About Me"
                  value={aboutSection1}
                  onChange={(e) => setAboutSection1(e.target.value)}
                />
              </div>
              <div className="grid gap-2">
                <Label>About Section 2</Label>
                <Textarea
                  className="About Me"
                  value={aboutSection2}
                  onChange={(e) => setAboutSection2(e.target.value)}
                />
              </div>
              <div className="grid gap-2">
