...
const ProjectView = () => {
  ...
  console.log(descriptionList, technologiesList);
          ...
          <div className="space-y-12">
            <div className="border-b border-gray-900/10 pb-12">
              ...
              <div className="mt-10 flex flex-col gap-5">
                ...
                <div className="w-full sm:col-span-4">
                  <p className="text-3xl font-bold mb-2">Stack:</p>
                  <p>{stack}</p>
                </div>
                <div className="w-full sm:col-span-4">
                  <p className="text-3xl font-bold mb-2">Deployed:</p>
                  <p>{deployed}</p>
                </div>
                <div className="w-full sm:col-span-4">
                ...
                <div className="w-full sm:col-span-4">
                  <p className="text-3xl font-bold mb-2">Project Link:</p>
                  <Link
                    className="text-sky-700"
                    target="_blank"
                    to={projectLink}
