...
const Hero = () => {
  ...
  return (
    <div className="w-full">
      ...
      >
        Hey, I'm {user.fullName ? user.fullName.split(" ")[0] : user.fullName}
      </h1>
      <h1
      ...
      >
        <Typewriter
          words={["FULLSTACK DEVELOPER", "SOFTWARE ENGINEER"]}
          loop={50}
          cursor
          typeSpeed={70}
          deleteSpeed={50}
      ...
      >
        <Link to={"https://www.youtube.com/@pranshugoyal1571"} target="_blank">
